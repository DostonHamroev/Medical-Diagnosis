...
class ResultActivity : AppCompatActivity() {
    ...
    private fun findVariant() {
        ...
        /* 2-variant */
        if ((b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && (c1!! >= 3 || c2!! >= 2) && d1 == 0) ||
            (b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && (c1!! == 0 || c2!! == 0) && d1 == 0)
        ) {
            Cache.variant = "2"
        }
        ...
        /* 3-variant */
        if ((b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b3!! >= 3 && (c1!! >= 3 || c2!! >= 2) && d1 == 0) ||
            (b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b3!! >= 3 && (c1!! == 0 || c2!! == 0) && d1 == 0)
        ) {
            Cache.variant = "3"
        }

        /* 4-variant */
        if ((b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && (c1!! >= 3 || c2!! >= 2) && d1 == 0) ||
            (b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && (c1!! == 0 || c2!! == 0) && d1 == 0)
        ) {
            Cache.variant = "4"
        }

        /* 5-variant */
        if ((b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 1) ||
            (b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1 == 1)
        ) {
            Cache.variant = "5"
        }
        ...
        /* 6-variant */
        if ((b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 0) ||
            (b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 0)
        ) {
            Cache.variant = "6"
        }
        ...
        /* 7-variant */
        if ((b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 2) ||
            (b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && d1 == 2) ||
            (b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1 == 2)
        ) {
            Cache.variant = "7"
        }
        ...
        if ((b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 1) ||
            (b1!! >= 3 && (a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 1)
        ) {
            Cache.variant = "8"
        }

//        if ((a1!! > 100 || a2!! != 100)){
//            binding.diagnosVariant.text = "вариант не найден"
//            binding.diagnosTv.text = "Диагноз"
//            binding.diagnosResult.text = "нет"
