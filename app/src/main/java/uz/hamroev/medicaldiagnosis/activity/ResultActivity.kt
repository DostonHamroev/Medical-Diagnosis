...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(
            TAG,
            "oldin:    A1=$a1   A2=$a2   B1=$b1   B2=$b2   B3=$b3   C1=$c1   C2=$c2   D1=$d1  Cache varint = ${Cache.variant}"
        )
        findVariants()
        //findVariant()
        checkLanguage()
        ...
        Log.d(
            TAG,
            "keyin:    A1=$a1   A2=$a2   B1=$b1   B2=$b2   B3=$b3   C1=$c1   C2=$c2   D1=$d1  Cache varint = ${Cache.variant}"
        )

    }


    private fun findVariants(): String {
        Cache.variant = "0"
        if ((a1!! > 0 || a2!! >= 0)) {

            /* 8-variant ########################### ready 8 var ################################*/
            if (
                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 1) ||

                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 2) ||
                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 2 && (c2!! < 2)) ||

                (b1!! >= 3 && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 2) ||
                (b1!! >= 3 && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 2 && (b3!! < 3)) ||

                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 2)
            ) {
                Cache.variant = "8"
                return "8"
            }
            ...
            /* 7-variant */
            if (
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && d1!! == 1 && (b2!! < 2 && b3!! < 3 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && d1!! == 1 && (b2!! < 2 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && d1!! == 1 && (b2!! < 2 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && d1!! == 1 && (b3!! < 3 && c2!! < 2)) ||

                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1!! == 1 && (b1!! < 3 && b3!! < 3 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1!! == 1 && (b1!! < 3 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1!! == 1 && (b1!! < 3 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1!! == 1 && (b3!! < 3 && c2!! < 2)) ||


                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1!! == 1 && (b1!! < 3 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1!! == 1 && (b1!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1!! == 1 && (c2!! < 2)) ||


                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 1 && (b2!! < 2 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 1 && (b2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 1 && (c2!! < 2)) ||

                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1!! == 1 && (c2!! < 2)) ||

                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 1 && (b2!! < 2 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 1 && (b2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 1 && (b3!! < 3)) ||

                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && d1!! == 1 && (c1!! >= 3 && b2!! < 2 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && d1!! == 1 && (c1!! >= 3 && b2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && d1!! == 1 && (c1!! >= 3 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && d1!! == 1 && (b2!! < 2 && b3!! < 3)) ||

                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && d1!! == 1 && (c1!! >= 3 && b1!! < 3 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && d1!! == 1 && (c1!! >= 3 && b1!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && d1!! == 1 && (c1!! >= 3 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && d1!! == 1 && (b1!! < 3 && b3!! < 3)) ||

                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && d1!! == 1 && (c1!! >= 3 && b1!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && d1!! == 1 && (c1!! >= 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && d1!! == 1 && (b1!! < 3)) ||

                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && d1!! == 1 && (c1!! >= 3 && b2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && d1!! == 1 && (c1!! >= 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && d1!! == 1 && (b2!! < 2)) ||

                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1!! == 1 && (b3!! < 3)) ||

                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b2!! >= 2 && d1!! == 1) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b2!! >= 2 && d1!! == 1 && (c1!! >= 3 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b2!! >= 2 && d1!! == 1 && (c1!! >= 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b2!! >= 2 && d1!! == 1 && (b3!! < 3)) ||

                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && d1!! == 2 ) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && d1!! == 2 && (b2!! < 2 && b3!! < 3 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && d1!! == 2 && (b2!! < 2 && b3!! < 3 )) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && d1!! == 2 && (b2!! < 2 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && d1!! == 2 && (b3!! < 3 && c2!! < 2)) ||

                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1!! == 2 ) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1!! == 2 && (b1!! < 3 && b3!! < 3 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1!! == 2 && (b1!! < 3 && b3!! < 3 )) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1!! == 2 && (b1!! < 3 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && d1!! == 2 && (b3!! < 3 && c2!! < 2)) ||

                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1!! == 2 ) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1!! == 2 && (b1!! < 3 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1!! == 2 && (b1!! < 3 )) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1!! == 2 && (c2!! < 2)) ||




                //pastdagi qatorda TZ 34 bet 57 var da berilishicha d1!! deb berilgan adashilgan bo'lishi mjumkin d3 bo'lishi kerak manimcha
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 0 ) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 0 && (b2!! < 2 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 0 && (b2!! < 2 )) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 0 && (c2!! < 2)) ||
                /**/

                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 2 ) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 2 && (b2!! < 2 && c2!! < 2)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 2 && (b2!! < 2 )) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1!! == 2 && (c2!! < 2)) ||

                // bu yerda ham shunaqa holat TZ 35 bet 62 variant d1!! bo'lgani uchun d1!!=0 qildim !
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 0) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 0 && (b2!! < 2 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 0 && (b2!! < 2 )) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 0 && (b3!! < 3)) ||

                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 2) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 2 && (b2!! < 2 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 2 && (b2!! < 2 )) ||
                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 2 && (b3!! < 3)) ||

                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1!! == 2 ) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1!! == 2 && (b1!! < 3 && b3!! < 3)) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1!! == 2 && (b1!! < 3 )) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1!! == 2 && (b3!! < 3)) ||

                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 2 ) ||
                ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 2 && (b1!! < 3)) ||

                ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1!! == 2) ||
            ...
            if (
                (b1!! >= 3 && c1!! >= 3 && d1 == 1) ||
                (b1!! >= 3 && c1!! >= 3 && d1 == 1 && (b2!! < 2 && b3!! < 3 && c2!! < 2)) ||
                (b1!! >= 3 && c1!! >= 3 && d1 == 1 && (b2!! < 2 && b3!! < 3)) ||
                (b1!! >= 3 && c1!! >= 3 && d1 == 1 && (b2!! < 2 && c2!! < 2)) ||
                (b1!! >= 3 && c1!! >= 3 && d1 == 1 && (b3!! < 3 && c2!! < 2)) ||

                (b2!! >= 2 && c1!! >= 3 && d1 == 1) ||
                (b2!! >= 2 && c1!! >= 3 && d1 == 1 && (b1!! < 3 && b3!! < 3 && c2!! < 2)) ||
                (b2!! >= 2 && c1!! >= 3 && d1 == 1 && (b1!! < 3 && b3!! < 3)) ||
                (b2!! >= 2 && c1!! >= 3 && d1 == 1 && (b1!! < 3 && c2!! < 2)) ||
                (b2!! >= 2 && c1!! >= 3 && d1 == 1 && (b3!! < 3 && c2!! < 2)) ||

                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 1) ||
                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 1 && (b1!! < 3 && c2!! < 2)) ||
                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 1 && (b1!! < 3)) ||
                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 1 && (c2!! < 2)) ||

                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1 == 1) ||
                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1 == 1 && (b2!! < 2 && c2!! < 2)) ||
                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1 == 1 && (b2!! < 2)) ||
                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1 == 1 && (c2!! < 2)) ||

                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 1) ||
                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 1 && (c2!! < 2)) ||

                (b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 1) ||
                (b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 1 && (b2!! < 2 && b3!! < 3)) ||
                (b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 1 && (b2!! < 2)) ||
                (b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 1 && (b3!! < 3)) ||

                (b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 1) ||
                (b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 1 && (b1!! < 3 && b3!! < 3)) ||
                (b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 1 && (b1!! < 3)) ||
                (b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 1 && (b3!! < 3)) ||

                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 1) ||
                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 1 && (b1!! < 3)) ||

                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 1) ||
                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 1 && (b2!! < 2)) ||

                (b1!! >= 3 && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 1) ||
                (b1!! >= 3 && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 1 && (b3!! < 3)) ||

                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 0)
            ) {
                Cache.variant = "6"
                return "6"
            }
            ...
            if (
                (b1!! >= 3 && c1!! >= 3 && d1 == 0) ||
                (b1!! >= 3 && c1!! >= 3 && d1 == 0 && (b2!! < 2 && b3!! < 3 && c2!! < 2)) ||
                (b1!! >= 3 && c1!! >= 3 && d1 == 0 && (b2!! < 2 && b3!! < 3)) ||
                (b1!! >= 3 && c1!! >= 3 && d1 == 0 && (b2!! < 2 && c2!! < 2)) ||
                (b1!! >= 3 && c1!! >= 3 && d1 == 0 && (b3!! < 3 && c2!! < 2)) ||

                (b2!! >= 2 && c1!! >= 3 && d1 == 0) ||
                (b2!! >= 2 && c1!! >= 3 && d1 == 0 && (b1!! < 3 && b3!! < 3 && c2!! < 2)) ||
                (b2!! >= 2 && c1!! >= 3 && d1 == 0 && (b1!! < 3 && b3!! < 3)) ||
                (b2!! >= 2 && c1!! >= 3 && d1 == 0 && (b1!! < 3 && c2!! < 2)) ||
                (b2!! >= 2 && c1!! >= 3 && d1 == 0 && (b3!! < 3 && c2!! < 2)) ||

                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 0) ||
                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 0 && (b1!! < 3 && c2!! < 2)) ||
                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 0 && (c2!! < 2)) ||
                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 0 && (b1!! < 3)) ||

                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1 == 0) ||
                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1 == 0 && (b2!! < 2 && c2!! < 2)) ||
                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1 == 0 && (b2!! < 2)) ||
                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && d1 == 0 && (c2!! < 2)) ||

                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 0) ||
                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && d1 == 0 && (c2!! < 2)) ||

                (b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 0) ||
                (b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 0 && (b2!! < 2 && b3!! < 3)) ||
                (b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 0 && (b2!! < 2)) ||
                (b1!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 0 && (b3!! < 3)) ||

                (b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 0) ||
                (b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 0 && (b1!! < 3 && b3!! < 3)) ||
                (b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 0 && (b1!! < 3)) ||
                (b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 0 && (b3!! < 3)) ||

                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 0) ||
                (b2!! >= 2 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 0 && (b1!! < 3)) ||

                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 0) ||
                (b1!! >= 3 && b3!! >= 3 && c1!! >= 3 && c2!! >= 2 && d1 == 0 && (b2!! < 2)) ||

                (b1!! >= 3 && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 0) ||
                (b1!! >= 3 && b2!! >= 2 && c1!! >= 3 && c2!! >= 2 && d1 == 0 && (b3!! < 3))
            ) {
                Cache.variant = "5"
                return "5"
            }
            ...
            if (
                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && d1 == 0) ||
                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && d1 == 0 && (c1!! < 2 && c2!! < 2)) ||
                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && d1 == 0 && (c1!! < 2)) ||
                (b1!! >= 3 && b2!! >= 2 && b3!! >= 3 && d1 == 0 && (c2!! < 2))
            ) {
                Cache.variant = "4"
                return "4"
            }
            ...
            if (
                (b2!! >= 2 && b3!! >= 3 && d1 == 0) ||
                (b2!! >= 2 && b3!! >= 3 && d1 == 0 && (b1!! < 3 && c1!! < 2 && c2!! < 2)) ||
                (b2!! >= 2 && b3!! >= 3 && d1 == 0 && (b1!! < 3 && c1!! < 2)) ||
                (b2!! >= 2 && b3!! >= 3 && d1 == 0 && (b1!! < 3 && c2!! < 2)) ||
                (b2!! >= 2 && b3!! >= 3 && d1 == 0 && (c1!! < 2 && c2!! < 2)) ||
                (b2!! >= 2 && b3!! >= 3 && d1 == 0 && (b1!! < 3)) ||
                (b2!! >= 2 && b3!! >= 3 && d1 == 0 && (c1!! < 2)) ||
                (b2!! >= 2 && b3!! >= 3 && d1 == 0 && (c2!! < 2)) ||

                (b1!! >= 3 && b3!! >= 3 && d1 == 0) ||
                (b1!! >= 3 && b3!! >= 3 && d1 == 0 && (b2!! < 2 && c1!! < 2 && c2!! < 2)) ||
                (b1!! >= 3 && b3!! >= 3 && d1 == 0 && (b2!! < 2 && c1!! < 2)) ||
                (b1!! >= 3 && b3!! >= 3 && d1 == 0 && (b2!! < 2 && c2!! < 2)) ||
                (b1!! >= 3 && b3!! >= 3 && d1 == 0 && (c1!! < 2 && c2!! < 2)) ||
                (b1!! >= 3 && b3!! >= 3 && d1 == 0 && (b2!! < 2)) ||
                (b1!! >= 3 && b3!! >= 3 && d1 == 0 && (c1!! < 2)) ||
                (b1!! >= 3 && b3!! >= 3 && d1 == 0 && (c2!! < 2))
            ...
            if (
                (b1!! >= 3 && d1!! == 0) ||
                ((b1!! >= 3 && d1!! == 0) && (b2!! < 2 && b3!! < 3 && c1!! < 2 && c2!! < 2)) ||

                ((b1!! >= 3 && d1!! == 0) && (b2!! < 2 && b3!! < 3 && c1!! < 2)) ||
                ((b1!! >= 3 && d1!! == 0) && (b2!! < 2 && b3!! < 3 && c2!! < 2)) ||
                ((b1!! >= 3 && d1!! == 0) && (b2!! < 2 && c1!! < 2 && c2!! < 2)) ||
                ((b1!! >= 3 && d1!! == 0) && (b2!! < 2 && c2!! < 2)) ||
                ((b1!! >= 3 && d1!! == 0) && (b2!! < 2 && c1!! < 2)) ||

                ((b1!! >= 3 && d1!! == 0) && (b3!! < 3 && c1!! < 2 && c2!! < 2)) ||
                ((b1!! >= 3 && d1!! == 0) && (b3!! < 3 && c1!! < 2)) ||
                ((b1!! >= 3 && d1!! == 0) && (b3!! < 3 && c2!! < 2)) ||


                (b2!! >= 2 && d1!! == 0) ||
                ((b2!! >= 2 && d1!! == 0) && (b1!! < 3 && b3!! < 3 && c1!! < 2 && c2!! < 2)) ||
                ((b2!! >= 2 && d1!! == 0) && (b1!! < 3 && b3!! < 3 && c1!! < 2)) ||
                ((b2!! >= 2 && d1!! == 0) && (b1!! < 3 && b3!! < 3 && c2!! < 2)) ||
                ((b2!! >= 2 && d1!! == 0) && (b1!! < 3 && c1!! < 2 && c2!! < 2)) ||
                ((b2!! >= 2 && d1!! == 0) && (b1!! < 3 && c2!! < 2)) ||
                ((b2!! >= 2 && d1!! == 0) && (b1!! < 3 && c1!! < 2)) ||

                ((b2!! >= 2 && d1!! == 0) && (b3!! < 3 && c1!! < 2 && c2!! < 2)) ||
                ((b2!! >= 2 && d1!! == 0) && (b3!! < 3 && c1!! < 2)) ||
                ((b2!! >= 2 && d1!! == 0) && (b3!! < 3 && c2!! < 2))
    ...
    private fun findVariant() {
        ...
        if (
            ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && d1!! == 0) ||
            ((a1!! > 0 || a2!! >= 0) && b1!! >= 3 && d1!! == 0 && (b2!! < 2 || b3!! < 3 || c1!! < 2 || c2!! < 2)) ||
            ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && d1!! == 0) ||
            ((a1!! > 0 || a2!! >= 0) && b2!! >= 2 && d1!! == 0 && (b1!! < 3 || b3!! < 3 || c1!! < 2 || c2!! < 2))
        ) {
            Cache.variant = "2"
