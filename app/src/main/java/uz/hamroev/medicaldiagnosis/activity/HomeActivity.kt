    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener {
            when(it.itemId){
                ...
                R.id.nav_result -> Toast.makeText(applicationContext, "Result", Toast.LENGTH_SHORT).show()
                ...
                R.id.nav_about -> Toast.makeText(applicationContext, "About App", Toast.LENGTH_SHORT).show()
